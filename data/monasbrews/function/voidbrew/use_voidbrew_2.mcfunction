effect give @a[distance=..10] slow_falling 1200 0
effect give @a[distance=..10] luck 1200 0
effect give @a[distance=..10] invisibility 1200 0
effect give @a[distance=..10] resistance 1200 0
